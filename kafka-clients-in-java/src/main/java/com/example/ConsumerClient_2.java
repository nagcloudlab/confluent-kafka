...
public class ConsumerClient_2 {
    private static final Logger logger = LoggerFactory.getLogger(ConsumerClient_2.class);
    ...
    public static void main(String[] args) {
        ...
        props.put(ConsumerConfig.GROUP_INSTANCE_ID_CONFIG, "consumer-instance-2"); // unique id for the consumer instance in the group ( static membership)
